package yaguhang.stadium.presentation;
...
public class StadiumController {
    ...
    public ResponseEntity<List<StadiumDetailInfo>> stadiumList() {
        List<StadiumDetailInfo> stadiumList = stadiumService.getStadiumList();
